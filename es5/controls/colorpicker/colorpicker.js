...
class ColorPicker extends _preactCompat.Component {
    ...
    render() {
        ...
        return _preactCompat2.default.createElement(
            ...
            _preactCompat2.default.createElement(
                ...
                _preactCompat2.default.createElement('span', { style: _extends({}, colorDropletStyle, { marginLeft: 'auto', backgroundColor: _colr2.default.fromHsvObject(hsvColor).toHex() }) })
            ),
            open ? _preactCompat2.default.createElement(
                'div',
                null,
                _preactCompat2.default.createElement(_hsvColorpicker2.default, { style: style, value: hsvColor, onChange: this.onColorChange }),
                _preactCompat2.default.createElement(_palette2.default, { key: 'user-palette', values: palette.map(toHsv), onSelect: this.onColorChange }),
                _preactCompat2.default.createElement(_palette2.default, { key: 'system-palette', values: this.getSystemColors(), onSelect: this.onColorChange, onDeselect: this.onRemoveColorClick.bind(this) }),
                _preactCompat2.default.createElement(_add2.default, { onClick: e => this.onAddColorClick(toHsv(value)) })
            ) : null
        );
    }
}
